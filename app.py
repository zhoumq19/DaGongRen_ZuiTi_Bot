...
class LLM:
    ...
    def generate(self, question: str, context: List, temperature: float = 1.0):
        ...
        outputs = self.model.generate(inputs,do_sample=True, max_length=1024,temperature=temperature)
...
for value in button_values:
    document_path=f'/mnt/workspace/打工嘴替机器人/{value}.txt'
    index_list.append(VectorStoreIndex(document_path, embed_model))
